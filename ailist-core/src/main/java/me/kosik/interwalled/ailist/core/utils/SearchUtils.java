...
public final class SearchUtils {
    ...
    public static <T> int findRightmost(ArrayList<Interval<T>> intervals, long queryStart) {
        return findRightmost(intervals, queryStart, 15);
    }

    public static <T> int findRightmost(ArrayList<Interval<T>> intervals, long queryEnd, long binaryCutoff) {
        // EDGE CASE:
